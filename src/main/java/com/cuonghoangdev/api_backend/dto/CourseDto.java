...
public class CourseDto {
    ...
    public void setDiscountExpiresAt(LocalDateTime discountExpiresAt) {
    ...
    public BigDecimal getEnrollmentProgress() {
        return enrollmentProgress;
    }

    public void setEnrollmentProgress(BigDecimal enrollmentProgress) {
