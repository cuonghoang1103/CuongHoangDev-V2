...
public class UpdateCourseRequest {
    ...
    public String getDiscountExpiresAt() { return discountExpiresAt; }
    public void setDiscountExpiresAt(String discountExpiresAt) { this.discountExpiresAt = discountExpiresAt; }
