              ...
              <div className="relative">
                ...
                {langMenuOpen && (
                  <>
                    ...
                    />
                    <div className="absolute right-0 top-full mt-1.5 w-28 bg-darkcard border border-darkborder rounded-xl shadow-xl z-50 overflow-hidden">
                      {routing.locales.map((loc) => (
                        ...
                        >
                          <span className="text-xs font-medium uppercase">{loc === 'vi' ? 'VN' : 'EN'}</span>
