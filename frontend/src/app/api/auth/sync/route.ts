...
/**
 * POST /api/auth/sync
 * Syncs a NextAuth social user to Spring Boot backend so they appear
 ...
 * Credentials users are already managed by Spring Boot directly.
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Try to register in Spring Boot (will fail silently if user already exists)
    try {
