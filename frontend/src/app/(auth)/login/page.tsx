      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary mt-2">
            Sign in to continue with CuongHoang
          </p>
        </div>
        ...
        <div className="bg-darkcard border border-darkborder rounded-2xl p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-sm text-neon-violet hover:text-neon-indigo transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3 px-4 bg-white/5 border border-darkborder rounded-xl text-text-primary font-medium hover:bg-white/10 transition-colors flex items-center justify-center gap-3"
            >
          ...
          <p className="text-center text-text-muted text-sm mt-6">
            ...
            <Link href="/register" className="text-neon-violet hover:text-neon-indigo transition-colors font-medium">
              Sign Up
            </Link>
          </p>
        </div>
